...
MultiModalQA is a challenging question answering dataset that requires joint reasoning over text, tables and images. For ease of use, table data is pre-converted and provided as PNG files. 
