...
## Cheetah: a multi-modal large language model empowered by controllable knowledge re-injection
Cheetah is a multi-modal large language model empowered by controllable knowledge re-injection, which can effectively handle a wide variety of interleaved vision-language instructions.

![images](figs/framework.svg)
